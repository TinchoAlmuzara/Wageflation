...
res_path  = [pwd filesep '..' filesep 'results' filesep 'realtime' filesep];
...
parfor i_work = 1:n_work
    ...
    date_str  = [data_cut '_' datestr(last_date, 'yyyymm')];
...
res_tmp     = load('results/results_industries.mat');
date        = res_tmp.dates;
twin        = res_tmp.TWIn(:,2);
common      = rest_tmp.TWIn_c(:, 2);
